...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./app/styles.css\");\n/* harmony import */ var _helpers_math__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/math */ \"./app/helpers/math.js\");\n/* harmony import */ var _helpers_state__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers/state */ \"./app/helpers/state.js\");\n/** @format */\r\n\r\n\r\n\r\n\r\n\r\ndocument.getElementById(\"calc\").addEventListener(\"click\", handleClick);\r\nfunction handleAction(action) {\r\n    switch (action) {\r\n        case \"add\":\r\n            _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.action = _helpers_math__WEBPACK_IMPORTED_MODULE_1__.add;\r\n            break;\r\n        case \"sub\":\r\n            _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.action = _helpers_math__WEBPACK_IMPORTED_MODULE_1__.sub;\r\n            break;\r\n        case \"mult\":\r\n            _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.action = _helpers_math__WEBPACK_IMPORTED_MODULE_1__.multiply;\r\n            break;\r\n        case \"div\":\r\n            _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.action = _helpers_math__WEBPACK_IMPORTED_MODULE_1__.divide;\r\n            break;\r\n    }\r\n    document.getElementById(action).classList.toggle(\"pressed\");\r\n    document.getElementById(\"mainResult\").value =\r\n        document.getElementById(\"result\").value;\r\n    document.getElementById(\"result\").value = \"\";\r\n    removePressed(action);\r\n    _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.flag = \"n2\";\r\n}\r\nfunction handleAdd() {\r\n    _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.action = _helpers_math__WEBPACK_IMPORTED_MODULE_1__.add;\r\n    document.getElementById(\"add\").classList.toggle(\"pressed\");\r\n    document.getElementById(\"mainResult\").value =\r\n        document.getElementById(\"result\").value;\r\n    document.getElementById(\"result\").value = \"\";\r\n    removePressed(\"add\");\r\n    _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.flag = \"n2\";\r\n}\r\nfunction handleSub() {\r\n    _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.action = _helpers_math__WEBPACK_IMPORTED_MODULE_1__.sub;\r\n    document.getElementById(\"sub\").classList.toggle(\"pressed\");\r\n    document.getElementById(\"mainResult\").value =\r\n        document.getElementById(\"result\").value;\r\n    document.getElementById(\"result\").value = \"\";\r\n    removePressed(\"sub\");\r\n    _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.flag = \"n2\";\r\n}\r\nfunction handleDiv() {\r\n    _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.action = _helpers_math__WEBPACK_IMPORTED_MODULE_1__.divide;\r\n    document.getElementById(\"div\").classList.toggle(\"pressed\");\r\n    document.getElementById(\"mainResult\").value =\r\n        document.getElementById(\"result\").value;\r\n    document.getElementById(\"result\").value = \"\";\r\n    removePressed(\"div\");\r\n    _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.flag = \"n2\";\r\n}\r\nfunction handleMult() {\r\n    _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.action = _helpers_math__WEBPACK_IMPORTED_MODULE_1__.multiply;\r\n    document.getElementById(\"mult\").classList.toggle(\"pressed\");\r\n    document.getElementById(\"mainResult\").value =\r\n        document.getElementById(\"result\").value;\r\n    document.getElementById(\"result\").value = \"\";\r\n    removePressed(\"mult\");\r\n    _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.flag = \"n2\";\r\n}\r\nfunction handleClick(e) {\r\n    const target = e.target.value;\r\n    if (!_helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.action) {\r\n        _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.flag = \"n1\";\r\n    }\r\n    if (\"1234567890.\".includes(target) && e.target.id !== \"result\") {\r\n        document.getElementById(\"result\").value += target;\r\n        _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state[_helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.flag] = parseFloat(document.getElementById(\"result\").value);\r\n    }\r\n    if (\"+\".includes(target)) {\r\n        handleAction(\"add\");\r\n    }\r\n    if (\"-\".includes(target)) {\r\n        handleAction(\"sub\");\r\n    }\r\n    if (\"/\".includes(target)) {\r\n        handleAction(\"div\");\r\n    }\r\n    if (\"X\".includes(target)) {\r\n        handleAction(\"mult\");\r\n    }\r\n    if (\"=\".includes(target)) {\r\n        if (!_helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.action) {\r\n            document.getElementById(\"mainResult\").value = \"choose action\";\r\n            return;\r\n        }\r\n        let actionSymbol;\r\n        switch (_helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.action) {\r\n            case _helpers_math__WEBPACK_IMPORTED_MODULE_1__.sub:\r\n                actionSymbol = \"-\";\r\n                break;\r\n            case _helpers_math__WEBPACK_IMPORTED_MODULE_1__.add:\r\n                actionSymbol = \"+\";\r\n                break;\r\n            case _helpers_math__WEBPACK_IMPORTED_MODULE_1__.multiply:\r\n                actionSymbol = \"X\";\r\n                break;\r\n            case _helpers_math__WEBPACK_IMPORTED_MODULE_1__.divide:\r\n                actionSymbol = \"/\";\r\n                break;\r\n        }\r\n        let result = (0,_helpers_math__WEBPACK_IMPORTED_MODULE_1__.equals)(_helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.n1, _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.n2, _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.action);\r\n        document.getElementById(\"result\").value = \"\";\r\n        _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.result = result;\r\n        document.getElementById(\"mainResult\").value =\r\n            _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.n1 +\r\n            \" \" +\r\n            actionSymbol +\r\n            \" \" +\r\n            _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.n2 +\r\n            \" = \" +\r\n            _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.result;\r\n        _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.n1 = result;\r\n        removePressed();\r\n        _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.action = null;\r\n\r\n        _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.n2 = 0;\r\n        console.log(_helpers_state__WEBPACK_IMPORTED_MODULE_2__.state);\r\n    }\r\n    if (\"Del\".includes(target)) {\r\n        let str = document.getElementById(\"result\").value.toString();\r\n        if (str.length > 1) {\r\n            let newNum = parseFloat(str.substring(0, str.length - 1));\r\n            document.getElementById(\"result\").value = newNum;\r\n            _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state[_helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.flag] = newNum;\r\n        }\r\n        if (str.length === 1) {\r\n            let newNum = 0;\r\n            document.getElementById(\"result\").value = newNum;\r\n            _helpers_state__WEBPACK_IMPORTED_MODULE_2__.state[_helpers_state__WEBPACK_IMPORTED_MODULE_2__.state.flag] = newNum;\r\n        }\r\n    }\r\n}\r\nfunction removePressed(action) {\r\n    for (let elem of document.getElementsByTagName(\"input\")) {\r\n        if (elem.id !== action) elem.classList.remove(\"pressed\");\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack://calc/./app/main.js?");
